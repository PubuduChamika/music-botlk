	...
	run: async function (client, message, args) {
		...
		if (url.match(/^https?:\/\/(www.youtube.com|youtube.com)\/playlist(.*)$/)) {
			...
			try {
				...
				let thing = new MessageEmbed()
					.setAuthor("Playlist has been added to queue", "https://github.com/PubuduChamika/files/blob/main/Music.gif?raw=true")
		...
		async function handleVideo(video, message, channel, playlist = false) {
			...
			if (!serverQueue) {
				...
				if (playlist) return;
				let thing = new MessageEmbed()
					.setAuthor("Song has been added to queue", "https://github.com/PubuduChamika/files/blob/main/Music.gif?raw=true")
...
let thing = new MessageEmbed()
				.setAuthor("Started Playing Music!", "https://github.com/PubuduChamika/files/blob/main/Music.gif?raw=true")
				.setThumbnail(song.img)
				.setColor("BLUE")
				.addField("Name", song.title, true)
				.addField("Duration", song.duration, true)
